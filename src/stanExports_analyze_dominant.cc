...
#include "stanExports_analyze_dominant.h"

RCPP_MODULE(stan_fit4analyze_dominant_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_analyze_dominant")
