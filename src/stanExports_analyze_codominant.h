...
namespace model_analyze_codominant_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_analyze_codominant");
    reader.add_event(84, 82, "end", "model_analyze_codominant");
    return reader;
}
#include <stan_meta_header.hpp>
class model_analyze_codominant
  : public stan::model::model_base_crtp<model_analyze_codominant> {
private:
        int N_loci;
        int N_pops;
        ...
        int f_zero;
public:
    model_analyze_codominant(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_analyze_codominant_namespace::model_analyze_codominant";
        ...
        try {
            ...
            context__.validate_dims("data initialization", "n", "int", context__.to_vec(N_pops,N_loci,3));
            n = std::vector<std::vector<std::vector<int> > >(N_pops, std::vector<std::vector<int> >(N_loci, std::vector<int>(3, int(0))));
            vals_i__ = context__.vals_i("n");
            pos__ = 0;
            size_t n_k_0_max__ = N_pops;
            size_t n_k_1_max__ = N_loci;
            size_t n_k_2_max__ = 3;
            for (size_t k_2__ = 0; k_2__ < n_k_2_max__; ++k_2__) {
                for (size_t k_1__ = 0; k_1__ < n_k_1_max__; ++k_1__) {
                    for (size_t k_0__ = 0; k_0__ < n_k_0_max__; ++k_0__) {
                        n[k_0__][k_1__][k_2__] = vals_i__[pos__++];
                    }
                }
            }
            size_t n_i_0_max__ = N_pops;
            size_t n_i_1_max__ = N_loci;
            size_t n_i_2_max__ = 3;
            for (size_t i_0__ = 0; i_0__ < n_i_0_max__; ++i_0__) {
                for (size_t i_1__ = 0; i_1__ < n_i_1_max__; ++i_1__) {
                    for (size_t i_2__ = 0; i_2__ < n_i_2_max__; ++i_2__) {
                        check_greater_or_equal(function__, "n[i_0__][i_1__][i_2__]", n[i_0__][i_1__][i_2__], 0);
                    }
                }
            }
            ...
            context__.validate_dims("data initialization", "f_zero", "int", context__.to_vec());
            f_zero = int(0);
            vals_i__ = context__.vals_i("f_zero");
            pos__ = 0;
            f_zero = vals_i__[pos__++];
            check_greater_or_equal(function__, "f_zero", f_zero, 0);
            check_less_or_equal(function__, "f_zero", f_zero, 1);
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            std::vector<std::vector<Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> > > x(N_loci, std::vector<Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> >(N_pops, Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1>(3)));
            stan::math::initialize(x, DUMMY_VAR__);
            stan::math::fill(x, DUMMY_VAR__);
            // transformed parameters block statements
            current_statement_begin__ = 35;
            if (as_bool(logical_eq(f_zero, 0))) {
                current_statement_begin__ = 36;
                stan::math::assign(f, inv_logit(logit_f));
            } else {
                current_statement_begin__ = 38;
                stan::math::assign(f, 0.0);
            }
            ...
            for (int i = 1; i <= N_loci; ++i) {
                ...
                for (int j = 1; j <= N_pops; ++j) {
                    ...
                    stan::model::assign(x, 
                                ...
                                ((pow(get_base1(get_base1(p, j, "p", 1), i, "p", 2), 2) * (1.0 - f)) + (f * get_base1(get_base1(p, j, "p", 1), i, "p", 2))), 
                    ...
                    stan::model::assign(x, 
                                ...
                                (((2.0 * get_base1(get_base1(p, j, "p", 1), i, "p", 2)) * (1.0 - get_base1(get_base1(p, j, "p", 1), i, "p", 2))) * (1 - f)), 
                                "assigning variable x");
                    ...
                    stan::model::assign(x, 
                                ...
                                ((pow((1.0 - get_base1(get_base1(p, j, "p", 1), i, "p", 2)), 2) * (1.0 - f)) + (f * (1.0 - get_base1(get_base1(p, j, "p", 1), i, "p", 2)))), 
                                "assigning variable x");
                }
            }
            ...
            for (size_t k_0__ = 0; k_0__ < x_k_0_max__; ++k_0__) {
                for (size_t k_1__ = 0; k_1__ < x_k_1_max__; ++k_1__) {
                    for (size_t j_1__ = 0; j_1__ < x_j_1_max__; ++j_1__) {
                        if (stan::math::is_uninitialized(x[k_0__][k_1__](j_1__))) {
                            std::stringstream msg__;
                            msg__ << "Undefined transformed parameter: x" << "[" << k_0__ << "]" << "[" << k_1__ << "]" << "(" << j_1__ << ")";
            ...
            for (int i = 1; i <= N_loci; ++i) {
                ...
                for (int j = 1; j <= N_pops; ++j) {
                    ...
                    lp_accum__.add(multinomial_log<propto__>(get_base1(get_base1(n, j, "n", 1), i, "n", 2), get_base1(get_base1(x, i, "x", 1), j, "x", 2)));
                }
            }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_analyze_codominant_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        try {
            ...
            validate_non_negative_index("x", "N_loci", N_loci);
            validate_non_negative_index("x", "N_pops", N_pops);
            std::vector<std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> > > x(N_loci, std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> >(N_pops, Eigen::Matrix<double, Eigen::Dynamic, 1>(3)));
            stan::math::initialize(x, DUMMY_VAR__);
            stan::math::fill(x, DUMMY_VAR__);
            ...
            if (include_tparams__) {
                ...
                for (size_t j_1__ = 0; j_1__ < x_j_1_max__; ++j_1__) {
                    for (size_t k_1__ = 0; k_1__ < x_k_1_max__; ++k_1__) {
                        for (size_t k_0__ = 0; k_0__ < x_k_0_max__; ++k_0__) {
                            vars__.push_back(x[k_0__][k_1__](j_1__));
                        }
                    }
                }
            }
            ...
            validate_non_negative_index("log_lik", "N_pops", N_pops);
            validate_non_negative_index("log_lik", "N_loci", N_loci);
            std::vector<std::vector<double> > log_lik(N_pops, std::vector<double>(N_loci, double(0)));
            ...
            for (int i = 1; i <= N_loci; ++i) {
                ...
                for (int j = 1; j <= N_pops; ++j) {
                    ...
                    stan::model::assign(log_lik, 
                                ...
                                multinomial_log(get_base1(get_base1(n, j, "n", 1), i, "n", 2), get_base1(get_base1(x, i, "x", 1), j, "x", 2)), 
                                "assigning variable log_lik");
                }
            }
            // validate, write generated quantities
            current_statement_begin__ = 75;
            size_t log_lik_k_0_max__ = N_pops;
            size_t log_lik_k_1_max__ = N_loci;
    ...
    std::string model_name() const {
        return "model_analyze_codominant";
    }
        ...
        if (include_tparams__) {
            ...
            for (size_t j_1__ = 0; j_1__ < x_j_1_max__; ++j_1__) {
                for (size_t k_1__ = 0; k_1__ < x_k_1_max__; ++k_1__) {
                    for (size_t k_0__ = 0; k_0__ < x_k_0_max__; ++k_0__) {
                        param_name_stream__.str(std::string());
                        param_name_stream__ << "x" << '.' << k_0__ + 1 << '.' << k_1__ + 1 << '.' << j_1__ + 1;
                        param_names__.push_back(param_name_stream__.str());
                    }
                }
            }
...
typedef model_analyze_codominant_namespace::model_analyze_codominant stan_model;
#ifndef USING_R
